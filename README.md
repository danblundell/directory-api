...
A data back-end for a community assets catalogue, driven by a mongodb database. It has:
...
It is front-end agnostic, but is intended to work with the `directory-frontend` repo.
